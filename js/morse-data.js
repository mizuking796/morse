...
const ABBREV_JA = [
  ...
  { group: 'CW略語（和文交信でも使用）', note: '和文だと長い挨拶も、欧文略語なら短く送れます', items: [
    { code: 'GM', meaning: 'おはよう（Good Morning）' },
    { code: 'GA', meaning: 'こんにちは（Good Afternoon）' },
    { code: 'GE', meaning: 'こんばんは（Good Evening）' },
    { code: 'GN', meaning: 'おやすみ（Good Night）' },
    { code: 'TNX', meaning: 'ありがとう（Thanks）' },
    { code: 'FB', meaning: '素晴らしい（Fine Business）' },
    { code: 'R', meaning: '了解（Roger）' },
    { code: 'PSE', meaning: 'お願いします（Please）' },
    { code: 'OM', meaning: '男性局長さん（Old Man）' },
    { code: 'YL', meaning: '女性局長さん（Young Lady）' },
  ]},
  { group: '数字略語（共通）', items: [
    { code: '73', meaning: '敬具（Best Regards）' },
...
const PRESETS_JA = [
  ...
  { label: 'GM（おはよう）', text: 'GM' },
  { label: 'GA（こんにちは）', text: 'GA' },
  { label: 'GE（こんばんは）', text: 'GE' },
  { label: 'TNX（ありがとう）', text: 'TNX' },
  { label: '73', text: '73' },
];
